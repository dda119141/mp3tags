...
int main(int argc, const char** argv) {
    ...
    auto parser =
        ...
        lyra::opt(directory, "dir")["--directory"]["-d"](
            ...
            .required() |
        lyra::opt([&](std::string artist) { gTags.push_back({std::string("title"), artist} ); },
                  "title")["--title"]["-a"]("Change the title frame content.") |
        lyra::opt([&](std::string artist) { gTags.push_back({std::string("genre"), artist} ); },
                  "genre")["--genre"]["-a"]("Change the genre frame content.") |
