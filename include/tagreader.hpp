...
const auto GetId3v2Tag(const std::string &fileName,
                       const id3v2::frameArray_t &tags) {

  const auto params = [&fileName, &tags]() {
    const auto id3Version = preCheckId3(fileName).id3Version;

    switch (id3Version) {
    case id3v2::tag_t::v30: {
      return audioProperties_t{id3v2::fileScopeProperties{
          fileName,
          id3v2::v30(),                        // Tag version
          tags.at(getIndex(id3v2::tag_t::v30)) // Frame ID
      }};
    } break;
    case id3v2::tag_t::v40: {
      return audioProperties_t{id3v2::fileScopeProperties{
          fileName,
          id3v2::v40(),                        // Tag version
          tags.at(getIndex(id3v2::tag_t::v40)) // Frame ID
      }};
    } break;
    case id3v2::tag_t::v00: {
      return audioProperties_t{id3v2::fileScopeProperties{
          fileName,
          id3v2::v00(),                        // Tag version
          tags.at(getIndex(id3v2::tag_t::v00)) // Frame ID
      }};
    } break;
    default: {
...
const auto GetAlbum(const std::string &filename) {
  static const id3v2::frame_t frames{{id3v2::tag_t::v40, "TALB"},
                                     {id3v2::tag_t::v30, "TALB"},
                                     {id3v2::tag_t::v00, "TAL"}};
...
const auto GetLeadArtist(const std::string &filename) {
  static const id3v2::frame_t frames{
      {id3v2::tag_t::v40, "TPE1"},
      {id3v2::tag_t::v30, "TPE1"},
      {id3v2::tag_t::v00, "TP1"},
  };
  const id3v2::frameID_s<id3v2::frame_t> Id3v2Tags{frames};
...
const auto GetComposer(const std::string &filename) {
  static const id3v2::frame_t frames{
      {id3v2::tag_t::v40, "TCOM"},
      {id3v2::tag_t::v30, "TCOM"},
      {id3v2::tag_t::v00, "TCM"},
  };
  const id3v2::frameID_s<id3v2::frame_t> id3v2Tags{frames};
...
const auto GetDate(const std::string &filename) {
  static const id3v2::frame_t frames{
      {id3v2::tag_t::v30, "TDAT"},
      {id3v2::tag_t::v40, "TDRC"},
      {id3v2::tag_t::v00, "TDA"},
  };
  const id3v2::frameID_s<id3v2::frame_t> id3v2Tags{frames};
  const auto ret = GetId3v2Tag(filename, id3v2Tags.mFrames);
...
const auto GetContentType(const std::string &filename) {
  static const id3v2::frame_t frames{
      {id3v2::tag_t::v40, "TCON"},
      {id3v2::tag_t::v30, "TCON"},
      {id3v2::tag_t::v00, "TCO"},
  };
  const id3v2::frameID_s<id3v2::frame_t> id3v2Tags{frames};
  const auto ret =
...
const auto GetComment(const std::string &filename) {
  static const id3v2::frame_t frames{
      {id3v2::tag_t::v40, "COMM"},
      {id3v2::tag_t::v30, "COMM"},
      {id3v2::tag_t::v00, "COM"},
  };
...
const auto GetTextWriter(const std::string &filename) {
  static const id3v2::frame_t frames{
      {id3v2::tag_t::v40, "TEXT"},
      {id3v2::tag_t::v30, "TEXT"},
      {id3v2::tag_t::v00, "TXT"},
  };
  const id3v2::frameID_s<id3v2::frame_t> id3v2Tags{frames};
  const auto ret = GetId3v2Tag(filename, id3v2Tags.mFrames);
...
const auto GetTitle(const std::string &filename) {
  static const id3v2::frame_t frames{
      {id3v2::tag_t::v40, "TIT2"},
      {id3v2::tag_t::v30, "TIT2"},
      {id3v2::tag_t::v00, "TT2"},
  };
  const id3v2::frameID_s<id3v2::frame_t> id3v2Tags{frames};
  const auto ret =
...
const auto GetContentGroupDescription(const std::string &filename) {
  static const id3v2::frame_t frames{
      {id3v2::tag_t::v40, "TIT1"},
      {id3v2::tag_t::v30, "TIT1"},
      {id3v2::tag_t::v00, "TT1"},
  };
  const id3v2::frameID_s<id3v2::frame_t> id3v2Tags{frames};
  const auto ret = GetId3v2Tag(filename, id3v2Tags.mFrames);
...
const auto GetTrackPosition(const std::string &filename) {
  static const id3v2::frame_t frames{
      {id3v2::tag_t::v40, "TRCK"},
      {id3v2::tag_t::v30, "TRCK"},
      {id3v2::tag_t::v00, "TRK"},
  };
  const id3v2::frameID_s<id3v2::frame_t> id3v2Tags{frames};
  const auto ret = GetId3v2Tag(filename, id3v2Tags.mFrames);
...
const auto GetBandOrchestra(const std::string &filename) {
  static const id3v2::frame_t frames{
      {id3v2::tag_t::v40, "TPE2"},
      {id3v2::tag_t::v30, "TPE2"},
      {id3v2::tag_t::v00, "TP2"},
  };
  const id3v2::frameID_s<id3v2::frame_t> id3v2Tags{frames};
  const auto ret = GetId3v2Tag(filename, id3v2Tags.mFrames);
